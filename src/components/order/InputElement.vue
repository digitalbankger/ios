  ...
  <div class="flex flex-col gap-2 w-full">
    ...
    >
      ...
      <input
        ...
        :disabled="disabled"
        v-model="inputValue"
        class="w-full py-2 px-3 border border-border h-30 bg-transparent outline-none text-gray-900 placeholder-gray-400"
        :class="inputClass"
        @input="handleInput"
    ...
    <textarea
      ...
      v-model="inputValue"
      :rows="props.rows"
      class="w-full py-2 px-3 border border-border bg-transparent outline-none text-gray-900 placeholder-gray-400 rounded-md"
      :class="inputClass"
      @input="handleInput"
    ></textarea>
