<template>
  <div class="flex flex-col items-center space-y-6 p-8 pt-20">
    ...
    <h1 class="text-2xl font-semibold text-center">Подтверждение кода</h1>
    <p class="text-black text-center text-lg w-full">
      Мы отправили код на <span class="font-medium">{{ dirtyIdentifier }}</span>
    </p>
    ...
    <div class="flex space-x-4">
      <input
        ...
        v-model="code[index]"
        maxlength="1"
        class="w-14 h-14 text-xl font-medium text-center bg-hoverbtn rounded-md focus:bg-white focus:outline-none"
